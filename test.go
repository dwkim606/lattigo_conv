...
func testResNet_crop() {
	...
	for i := 1; i <= num_blc1; i++ {
		...
		if i == 1 {
			ct_layer = evalConv_BNRelu_new(cont, ct_layer, ker_in0, bn_a1, bn_b1, alpha, in_wids[0], raw_in_wids[0], ker_wid, 3, real_batch[0], norm[0], 0, 2, "Conv", fast_pack, prt_result)
		} else {
