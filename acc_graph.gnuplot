...
set arrow from 4000, graph 0 length graph  .01 angle 75 nohead lw 2 front
set arrow from 4000, graph 0 length graph -.01 angle 75 nohead lw 2 front
set arrow from 13000, graph 0 length graph  .01 angle 75 nohead lw 2 front
set arrow from 13000, graph 0 length graph -.01 angle 75 nohead lw 2 front

set arrow from 4000, graph 1 to 13000, graph 1 nohead lt 4000 lw 2 lc rgb "white" front
set arrow from 4000, graph 1 length graph  .01 angle 75 nohead lw 2 front
set arrow from 4000, graph 1 length graph -.01 angle 75 nohead lw 2 front
set arrow from 13000, graph 1 length graph  .01 angle 75 nohead lw 2 front
set arrow from 13000, graph 1 length graph -.01 angle 75 nohead lw 2 front
...
set label "Falcon (Lou et al., 2020)" at 200, 78.5
...
set arrow from 200,78 to 111, 76.7 lw 2
...
plot 'acc.dat' using 1:2 with points ls 1 notitle, \
    ...
    'acc_lee.dat' using 1:2 with linespoints ls 1 notitle
